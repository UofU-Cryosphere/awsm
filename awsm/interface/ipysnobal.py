...
class PySnobal():
    ...
    def output_timestep(self):
        ...
        out_freq = (self.time_step.hour * self.data_time_step /
                    3600.0) % self.options['output']['frequency'] == 0 # change self.step_index to self.time_step.hour -pk ensures we get data on 0,6,12,18z times
